...
st=datenum(2016,8,1) # start time
et=datenum(2016,11,1) # end time
sname='flux_wo_tide.th' # save name
dt=900 # time step of flow.th (second)
pt=1 # check result 1:on
lwp=1; cutfreq=13 # low-pass filter and cut freqeuncy (hr)
...
for file in usgs:
    ...
    if lwp==1: nrd = lpfilt(nrd,dt/3600/24,cutfreq/24)

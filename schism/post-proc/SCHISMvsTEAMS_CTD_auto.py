#!/usr/bin/env python3
"""
Adapter runner for SCHISMvsTEAMS_CTD.py.

Purpose:
  - Keep SCHISMvsTEAMS_CTD.py unchanged.
...
DEFAULT_SCRIPT = SCRIPT_DIR / "SCHISMvsTEAMS_CTD.py"
...
def _parse_args():
    p = argparse.ArgumentParser(description="Run SCHISMvsTEAMS_CTD.py with JSON overrides.")
    p.add_argument("--script", default=str(DEFAULT_SCRIPT), help="Path to SCHISMvsTEAMS_CTD.py")

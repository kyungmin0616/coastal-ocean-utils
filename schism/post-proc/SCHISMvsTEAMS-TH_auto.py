#!/usr/bin/env python3
"""
Adapter runner for SCHISMvsTEAMS-TH.py.

Purpose:
  - Keep SCHISMvsTEAMS-TH.py unchanged.
...
DEFAULT_SCRIPT = SCRIPT_DIR / "SCHISMvsTEAMS-TH.py"
...
def _parse_args():
    p = argparse.ArgumentParser(description="Run SCHISMvsTEAMS-TH.py with JSON overrides.")
    p.add_argument("--script", default=str(DEFAULT_SCRIPT), help="Path to SCHISMvsTEAMS-TH.py")

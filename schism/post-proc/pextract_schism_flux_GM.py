...
# GM info
# CMEMS
sname='./npz/CMEMS_flux_2016'
dir_data='/rcfs/projects/mhk_modeling/dataset/CMEMS/ECGOM/daily/'
variables=['longitude','latitude','depth','uo','vo'] # CMEMS

#HYCOM
#sname='./npz/HYCOM_flux_2016'
...
#txy=[[[-521.402671, 99321.235753], [2963981.428258, 2959984.100407]]] # UTM 18
txy=[[[-521.402671, 120000], [2963981.428258, 2959984.100407]]] # UTM 18

StartT=datenum(2016,1,1); EndT=datenum(2016,10,30)

subdm=[-82.9,-74.9,20.3,33.6]

#optional
dx=1000          #interval of sub-section, used to divide transect
...
ibatch=0; scrout='screen_{}.out'.format(sname); bdir=os.path.abspath(os.path.curdir)
#-----------------------------------------------------------------------------

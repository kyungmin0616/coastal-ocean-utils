...
! ifort -O2 -mcmodel=medium -assume byterecl -CB -g -traceback -o gen_hot_from_nc ~/Codes/schism/src/Utility/UtilLib/schism_geometry.f90 \
! ~/Codes/schism/src/Utility/UtilLib/extract_mod.f90 ~/Codes/schism/src/Utility/UtilLib/compute_zcor.f90 \
! ~/Codes/schism/src/Utility/UtilLib/pt_in_poly_test.f90 gen_hot_from_nc.f90 \
! -I$NETCDF_INCLUDE -I$NETCDF_INCLUDE -L$NETCDF_LIB -L$NETCDF_LIB -lnetcdf -lnetcdff
